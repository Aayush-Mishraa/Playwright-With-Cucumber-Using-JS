...
test("@web Login into new Applcation", async ({ page }) => {
...
await page.locator("[placeholder*='Country']").pressSequentially("ind", { delay: 150 });
    ...
    await expect( page.locator(".user__name  [type='text']").first()).toHaveText(username)//this is assertion to check if the email is correct or not
